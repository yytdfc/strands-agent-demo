...
fork from: https://github.com/strands-agents/sdk-python/blob/main/src/strands/models/openai.py
...
class SageMakerModel(Model):
    """SageMaker model provider implementation."""
    ...
    def __init__(self, endpoint_name: str, region_name=None, **model_config: Unpack[OpenAIConfig]) -> None:
        ...
        self.sagemaker_runtime = boto3.client('runtime.sagemaker', region_name=region_name)
